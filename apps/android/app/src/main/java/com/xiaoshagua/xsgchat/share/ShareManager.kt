package com.xiaoshagua.xsgchat.share
...
class ShareManager @Inject constructor(
    ...
    companion object {
         ...
         * FileProvider授权
         */
        const val FILE_PROVIDER_AUTHORITY = "com.xiaoshagua.xsgchat.fileprovider"
    }
            ...
            val shareText = buildString {
                ...
                messages.forEach { message ->
                    val sender = when (message.role) {
                        com.xiaoshagua.xsgchat.data.model.MessageRole.USER -> "我"
                        com.xiaoshagua.xsgchat.data.model.MessageRole.ASSISTANT -> message.senderName ?: "AI"
                        com.xiaoshagua.xsgchat.data.model.MessageRole.SYSTEM -> "系统"
                    }
